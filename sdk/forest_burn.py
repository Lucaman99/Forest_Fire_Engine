        ...
        for tr in trees_to_spread_from:
            ...
            for xc in range(0, 4):
                ...
                if ([tr[0]+random_move[0], tr[1]+random_move[1]] in better_grid and [tr[0]+random_move[0], tr[1]+random_move[1]] not in trees_are_here):
                    ...
                    grid_found[grid_found.index([tr[0]+random_move[0], tr[1]+random_move[1]], 1, 0)][2] = 1
                    grid_found[grid_found.index([tr[0]+random_move[0], tr[1]+random_move[1]], 1, 0)].append(counter+1)
