...
for r in range(0, len(lists)):
    ...
    if hum_init.count([da_boi3_co, da_boi3_co]) > 0:
        humidity[hum_init.index([da_boi3_co, da_boi3_co])] = [
            da_boi2_hum,
            da_boi3_co,
            da_boi3_co,
        ]
    ...
    if temp_init.count([da_boi3_co, da_boi3_co]) > 0:
        temperature[temp_init.index([da_boi3_co, da_boi3_co])] = [
            da_boi2_temp,
            da_boi3_co,
            da_boi3_co,
        ]
    ...
    if light_init.count([da_boi3_co, da_boi3_co]) > 0:
        light[light_init.index([da_boi3_co, da_boi3_co])] = [
            da_boi2_light,
            da_boi3_co,
            da_boi3_co,
        ]
            ...
            if j == o:
                ...
                for p in range(0, len(first_list)):
                    ...
                    if first_list[p] > 0:
                        ...
                        final_boy = (
                            final_boy + final * (1 / float(first_list[p])) * grid_spread[p][2]
                        )
                    ...
                    if counting - h[x][3] <= 3:
                        ...
                        for b in boi:
                            if b[0] == h[x][0] + v[0] and b[1] == h[x][1] + v[1]:
                                ...
                                if r_var_temp < 35:
                                    prob_boy1 = int(
                                        round((((r_var_temp / 1.7 + 36) / 82) + 0.08) * 1310)
                                    )
                                else:
                                    prob_boy1 = 1000
                                if r_var_hum > 5:
                                    prob_boy2 = int(
                                        round(((-1 * r_var_hum / 1.6 + 33) / 70 + 0.3) * 1310)
                                    )
                                else:
                                    prob_boy2 = 1000
                                if r_var_light < 800:
                                    prob_boy3 = int(
                                        round(((r_var_light / 1.9 + 600) / 28 + 0.8) * 27)
                                    )
                                else:
                                    prob_boy3 = 1000
                                if boi.index(b) + 40 * v[0] + v[1] < 1600:
                                    ...
                                    if elev2 - elev == 0:
                                        ...
                                        slope_fin = (
                                            2 ** (abs(slope_style2 - slope_style) / 10) * 5 + 20
                                        )
                                    elif elev2 - elev < 0:
                                        slope_fin = -1 * (
                                            2 ** (abs(slope_style2 - slope_style) / 10) * 5 + 20
                                    ...
                                    if boi2 != None:
                                        if v[0] == 0 and v[1] == 1:
                                            if (
                                                ...
                                                directional_prob = int(
                                                    round(
                                                        (boi2[1] * 35 / (1.4) + boi2[0][1] * 600)
                                                        / 7
                                                    )
                                                    - 30
                                                )
                                    ...
                                    final = int(
                                        round(
                                            (prob_boy1 + prob_boy2 + prob_boy3) / 3
                                            - 250
                                            + slope_fin
                                            + directional_prob
                                        )
                                ...
                                if h[x][3] < counting and h[x][3] > counting - 3:
                                    if final_prob == True:
                                        ...
                                        h.append(
                                            [h[x][0] + v[0], h[x][1] + v[1], "burn", counting,]
                                        )
                                        # if (ros == True):
...
cur = db.cursor()
lists = ""
for g in measure((da_boi2_tree / da_boi3_co) * 40, 40):
    for t in g:
        lists = lists + str(t) + ","
    lists = lists + ";"
