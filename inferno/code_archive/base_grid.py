...
def CreateRandomGrid(
    width, length, tree_density, starting_coordinate_width, starting_coordinate_length
):
    counter = 0
    grid = generate_grid(
        width, length, starting_coordinate_width, starting_coordinate_length
    )  # Initialize grid
...
def CreateFixedGrid(
    width, length, coordinate_file, starting_coordinate_width, starting_coordinate_length,
):
